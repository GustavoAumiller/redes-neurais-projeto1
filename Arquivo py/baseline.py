...
CONFIGURACOES = [
    {"nome": "MLP_4",   "hidden": [16],      "activation": "tanh",    "lr": 0.01},
    {"nome": "MLP_8",   "hidden": [32],      "activation": "tanh",    "lr": 0.01},
    {"nome": "MLP_16",  "hidden": [64],     "activation": "tanh",    "lr": 0.01},
    {"nome": "MLP_8_4", "hidden": [128, 64],   "activation": "tanh",    "lr": 0.01},
    {"nome": "MLP_16_8","hidden": [16, 8],  "activation": "tanh",    "lr": 0.01},
    {"nome": "MLP_8",   "hidden": [32],      "activation": "relu",    "lr": 0.01},
    {"nome": "MLP_16",  "hidden": [64],     "activation": "relu",    "lr": 0.01},
    {"nome": "MLP_8_4", "hidden": [64, 128],   "activation": "relu",    "lr": 0.01},
]
